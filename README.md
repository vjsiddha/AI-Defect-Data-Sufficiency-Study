...
<p align="center">
  <img src="report/figures/manufacturing_data_paradox.png" width="950">
</p>

<p align="center">
<i><b>Figure 1.</b> High-quality manufacturing creates fewer defective parts—the very data AI inspection systems need most for training.</i>
</p>
---
...
Collecting more real defects on purpose isn't a real option either. You can't deliberately run a process out of spec to manufacture training data as that defeats the entire purpose of quality control, and in a lot of contexts (safety-critical parts, expensive raw material, contractual quality commitments) it's simply not something a plant manager would ever sign off on. So the realistic alternative is waiting, running production and hoping enough real defects occur naturally over time. That's slow, and it leaves an inspection system under-trained and under-validated during exactly the window(new launch, a process change) when defects are most likely and inspection coverage matters most.  
...
Most synthetic defect generation papers optimize for benchmark accuracy such as mean average precision, F1 score. Very few ask the question a Quality Engineer actually has to answer before approving an AI inspection system: how does this change escape risk and scrap cost? I wanted to evaluate synthetic defect generation the way I'd evaluate any new inspection tool, through escape rate and false rejection rate, repeated trials, and a healthy amount of skepticism, rather than as another computer vision benchmark.

<p align="center">
  <img src="report/figures/study_workflow.png" width="950">
</p>

<p align="center">
<i><b>Figure 2.</b> End-to-end workflow of the three-phase study, from establishing a baseline to generating synthetic defects and evaluating nine experimental conditions.</i>
</p>
---
...
**Accuracy** — included because it's the number everyone expects to see, but treated as secondary throughout. A model can post a great accuracy score while quietly making one of the two errors above at an unacceptable rate, which is why accuracy alone can't tell you which error you're trading for which.
...
<p align="center">
  <img src="report/figures/experimental_design.png" width="950">
</p>

<p align="center">
<i><b>Figure 3.</b> Experimental design showing how real and synthetic scratch images were combined while all other variables remained fixed.</i>
</p>
...
<p align="center">
  <img src="report/figures/synthetic_generation_examples2.png" width="950">
</p>

<p align="center">
<i><b>Figure 4.</b> Comparison between real scratch defects (top) and VLM-guided synthetic scratch defects (bottom). The generated scratches preserve the overall appearance and texture of the original manufacturing defects while introducing additional visual variation for training.</i>
</p>
...
<p align="center">
  <img src="report/figures/results_dashboard.png" width="950">
</p>

<p align="center">
<i><b>Figure 5.</b> Performance trends across the study. Synthetic defect data generally reduced escape rate but increased false rejection rate, while overall accuracy changed relatively little.</i>
</p>
...
<p align="center">
  <img src="report/figures/engineering_takeaways.png" width="950">
</p>

<p align="center">
<i><b>Figure 6.</b> Practical engineering conclusions drawn from the study. Synthetic defects altered inspection behavior more than overall classification performance and should be viewed as a supplement to—not a replacement for—real manufacturing defect data.</i>
</p>
---
